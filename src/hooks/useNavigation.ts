...
export type View = 'home' | 'complaint' | 'summarizer' | 'history' | 'correction' | 'exhibit' | 'cost' | 'admin_appeal' | 'demand_letter' | 'divorce' | 'lawyer_reg' | 'security' | 'admin' | 'customer_center' | 'lawyer_review' | 'lawyer_search' | 'subscription' | 'litigation_finder' | 'about';
