    ...
    async function loadPolicies() {
      try {
        ...
        if (termsDoc.exists()) {
          ...
          setTermsContent(`[SoloLaw] 서비스 이용약관

[제1장] 총칙

제1조 (목적)
본 약관은 나홀로소송 도우미 (SoloLaw)가 제공하는 'SoloLaw' 서비스(이하 '서비스')를 이용함에 있어 회사와 회원 간의 권리, 의무 및 책임 사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

제2조 (용어의 정의)
SoloLaw 서비스: 회사가 운영하는 모바일 앱 또는 웹 인터페이스를 통해 제공되는 다음 각 목의 솔루션을 의미합니다.
